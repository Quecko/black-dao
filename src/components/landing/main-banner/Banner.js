...
.modal-content {
  background: ${props => props.colorData?.bodyColor} !important;
  border-radius:10px;
}
.modal-header {
  border-bottom-color: ${props => props.colorData?.accentColor} !important;
  background-color: ${props => props.colorData?.bodyColor} !important;
}
...
.custom-switch .custom-control-input:disabled:checked~.custom-control-label::before {
  ...
  .another_card_section .bottom_cards .content-wrap .Cards_box .card_item .input_btn button:disabled {
...
{load && <Loader text={textMessage} />}
    <Container colorData={colorData}>
      ...
      <section className="banner" style={{ backgroundColor: `${colorData?.headerBackGroundColor}` }}>
        <div className="container-fluid">
          <div className="row">
            <div className="col-xl-7 col-12 m-auto">
              <h1 className="text-capitalize" style={{ color: `${colorData?.headerTitleTextColor}` }}>
                {colorData?.headerTitleText ? colorData?.headerTitleText : 'Title'}
              </h1>
              <p style={{ color: `${colorData?.headerDetailTextColor}` }}>
                {colorData?.headerDetailText ? colorData?.headerDetailText : 'Detail text with appear here.'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-xl-11 col-lg-11 col-md-12 col-12 m-auto">
              <div className="hdhdhd">
                ...
                <span style={{ backgroundColor: `${colorData?.accentColor}` }}>
                  {/* <img
      ...
      <section className="another_card_section " style={{ backgroundColor: `${colorData?.bodyColor}` }}>
        <div className="row">
                ...
                <div className="switch">
                  <div class="custom-control custom-switch">
                    <input
                      ...
                      id="customSwitch1"
                    />
                    <label class="custom-control-label checkCustom" for="customSwitch1">
                      Staked only
                    </label>
                  </div>
                </div>
                    ...
                    <div className="row">

                      {
                        allPools?.map((pool, index) => {
                          return (
                            <PoolCard pool={pool} colorData={colorData} index={index} stakedOnly={stakedOnly} setLoad={setLoad} settextMessage={settextMessage} />
                          )
                        })
                      }
                    </div>
                  ...
                  <div className="Cards_box">
                    <CardDiv colorData={colorData} className="card_item">
                      ...
                      <div className="input_btn">
                        <h6>BUSD Earned</h6>
                        <input className="px-2" type="search" placeholder="0.00" />
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <p>Available Balance: <span>2.211 BNB</span> </p>
                <div className="timer">
                  <h6>Remaining Time: <span>28d  :  21h  :  11m:  16s</span></h6>
                </div>
